...
path <- paste(urld, "acc=GSE184942", "file=GSE184942_raw_counts_GRCh38.p13_NCBI.tsv.gz", sep="&");
...
plotDispEsts(ds, main="GSE184942 Dispersion Estimates")

# create histogram plot of p-values
hist(r$padj, breaks=seq(0, 1, length = 21), col = "grey", border = "white", 
         xlab = "", ylab = "", main = "GSE184942 Frequencies of padj-values")
...
par(mar=c(7,4,2,1))
boxplot(dat[,ord], boxwex=0.6, notch=T, main="GSE184942", ylab="lg(norm.counts)", outline=F, las=2, col=gs[ord])
