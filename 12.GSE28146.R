...
gset <- getGEO("GSE28146", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "111111110000000000000000000000"
...
par(mar=c(7,4,2,1))
title <- paste ("GSE28146", "/", annotation(gset), sep ="")
...
par(mar=c(4,4,2,1))
title <- paste ("GSE28146", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE28146")
