...
gset <- getGEO("GSE29378", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- "01XXX1X1X0XX00X0XXXX11X0XXX1X110XXXX0XX00X10XXXX111X011XX10001X"
...
tT <- subset(tT, select=c("ID","adj.P.Val","P.Value","t","B","logFC","GI","SEQUENCE","GB_ACC","Gene.symbol","Gene.title"))
...
par(mar=c(7,4,2,1))
title <- paste ("GSE29378", "/", annotation(gset), sep ="")
...
par(mar=c(4,4,2,1))
title <- paste ("GSE29378", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE29378")
